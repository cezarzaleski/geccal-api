...
import { Sex } from 'src/emprestimo/domain/entity/sex'
import { HospitalizationStatus } from 'src/emprestimo/domain/entity/hospitalization-status'
import Patient from 'src/emprestimo/domain/entity/patient'
