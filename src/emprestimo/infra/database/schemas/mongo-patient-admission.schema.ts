...
import { MongoPatientSchema } from 'src/emprestimo/infra/database/schemas/mongo-patient.schema'
import { MongoInitialHealthSchema } from 'src/emprestimo/infra/database/schemas/mongo-initial-health.schema'
import { MongoAdmissionSchema } from 'src/emprestimo/infra/database/schemas/mongo-admission.schema'
