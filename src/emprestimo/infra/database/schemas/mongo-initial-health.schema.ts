...
import MechanicalVentilation from 'src/emprestimo/domain/entity/mechanical-ventilation'
import { ConsciousnessLevel } from 'src/emprestimo/domain/entity/consciousness-level'
import Diagnostic from 'src/emprestimo/domain/entity/diagnostic'
import InitialHealth from 'src/emprestimo/domain/entity/initial-health'
import Lesion from 'src/emprestimo/domain/entity/lesion'
